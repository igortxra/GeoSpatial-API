...
def create_app() -> FastAPI:
    ...
    @app.get("/aggregates/", response_model=List[RoadAggregatedResponse], tags=["Aggregations"])
    ...
    @app.post("/aggregates/spatial_filter/", response_model=List[RoadAggregatedResponse], tags=["Aggregations"])
    ...
    @app.get("/aggregates/{link_id}", response_model=RoadAggregatedResponse, tags=["Aggregations"])
    ...
    @app.get("/patterns/slow_links/", tags=["Patterns"])
    def get_slow_links(
